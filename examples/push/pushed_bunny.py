...
from utils.mesh_helper import calculate_z_lowest_mesh
...
from utils.mesh_helper import calculate_z_lowest_sphere_set


class PushedBunnyExample(BasePush):
    def __init__(self, viewer=None, args=None):
        super().__init__(viewer, args)
        self.example_name = "pushed_bunny"
        ...
        if self.experiment in ["tetxpbd", "mujoco", "semieuler"]:
            ...
            wp.launch(
                ...
                inputs=[self.state_0.particle_f, self.constant_force,
                        self.model.particle_mass, self.bunny.particle_mass_sum],
                device=wp.get_device(),
            )
    ...
    def calculate_analytical_state(self, t):
        ...
        return push_object_on_ground_solution(x0=x0, rot0=rot0, m=self.bunny.mass,
...
if __name__ == "__main__":
    ...
    example = PushedBunnyExample(viewer, args=args)
